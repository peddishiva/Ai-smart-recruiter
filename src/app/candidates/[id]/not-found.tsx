    ...
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
        <PageHeader
          ...
          description="This demo candidate does not exist in the current local dataset."
        />
        <EmptyState
          icon={<SearchX className="h-8 w-8" aria-hidden="true" />}
          title="No candidate found"
          description="Choose an existing demo candidate from the Candidates page."
          action={
            <Button href="/candidates" variant="primary" size="sm">
              Back to Candidates
            </Button>
          }
        />
